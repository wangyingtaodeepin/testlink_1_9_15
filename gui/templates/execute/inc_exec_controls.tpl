            ...
            {if $args_save_type == 'bulk'} {$args_labels.test_exec_result} {else} &nbsp; {/if}
              ...
              {if $args_save_type == 'single'}
                ...
                <br />    
                      ...
                      onclick="document.getElementById('save_button_clicked').value={$args_tcversion_id};return checkSubmitForStatusCombo2('statusSingle_{$tcversion_id}','{$ResultsStatusCode.not_run}','execution_duration')"
                  ...
                  <input type="submit" name="move2next[{$args_tcversion_id}]" 
                      ...
                      onclick="return checkDoBulkSave('execution_duration')"
      	    	             value="{$args_labels.btn_save_tc_exec_results}"/>
